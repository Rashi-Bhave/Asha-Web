...
// Add this function to your Services/Problem.service.js file

export const createProblemService = async (problemData) => {

  console.log("In create problem")
  try {
    const response = await axios.post(`${backendURL}/problem/createproblem`, problemData);
