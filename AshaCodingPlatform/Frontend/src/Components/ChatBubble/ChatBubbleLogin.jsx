...
import FAQChatInterface from '../Chat/FAQChatInterface';

const ChatBubbleLogin = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentMessageIndex((prev) => (prev + 1) % faqPrompts.length);
    }, 5000);
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50">
          ...
          <div className="cyber-chat-modal-fullscreen">
            ...
            {/* Full screen chat interface - Using our new FAQChatInterface */}
...
export default ChatBubbleLogin;